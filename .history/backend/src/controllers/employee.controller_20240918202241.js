...
const editEmployee=async (req, res) => {
    ...
    if(!req.params.id){
        return res.status(400).json({ message: "Invalid employee Id", "employee": employee });
    }
    ...
    try {
        ...
        return res.status(400).json({ message: "employee fetched successfully", "employee": employee });
    } catch (err) {
        console.log(err);
